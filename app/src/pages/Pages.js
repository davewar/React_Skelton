...
} from '../public_pages/contact/Contact';
import Services from '../public_pages/services/Services';

import BlogList, {
	loader as blogPageLoader,
} from '../public_pages/blog/BlogList';
import BlogItem from '../public_pages/blog/BlogItem';
...
const router = createBrowserRouter(
	createRoutesFromElements(
		...
		>
			...
			<Route
				element={
					<RequireAuth allowedRoles={[ROLES.Editor, ROLES.User, ROLES.Admin]} />
				}
			>
				...
				<Route path={'/projects'} element={<ProjectsMain />}>
					...
					<Route path={'/projects/item/:id'} element={<ProjectAmend />}></Route>
					<Route
